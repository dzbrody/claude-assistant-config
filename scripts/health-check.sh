...
MOUNTS=(
  "GoogleDrive-db@ctorescues.com/My Drive"
  "GoogleDrive-db@ctorescues.com/Shared drives/XGC"
  "GoogleDrive-db@ctorescues.com/Shared drives/AXINAGRP"
  "GoogleDrive-db@ctorescues.com/Shared drives/CCCL"
  "GoogleDrive-db@ctorescues.com/Shared drives/Development"
  "GoogleDrive-db@ctorescues.com/Shared drives/XGC-WORKING_FILES"
